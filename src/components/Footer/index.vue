<template>
  ...
  >
    ...
    >
      <v-col
        class="grey lighten-4 pt-2 block--text text-center"
        :cols="footerCols"
      > 
        <v-btn icon class="pb-1">
          <v-icon>mdi-forest</v-icon>
        </v-btn>
        <span>{{ new Date().getFullYear() }} — <strong>MyBlog</strong></span>
      </v-col>

      <v-col
        class="grey lighten-4 pt-2 text-center"
        :cols="footerCols"
      >
        <v-btn icon class="pb-1">
...
.footer-top{
  margin: 0 12% 0 12%;
  border-top: 1px solid rgb(207, 211, 214);
}
.footer-a{
